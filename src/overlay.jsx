  ...
  return (
    <OverlayDiv>
      <svg
        ...
        <g
          id="layer1"
          transform="translate(-79.650476,-86.421079)">
          <path
            id="rect531"
          ...
          <text
            style={{fontWeight:"bold",fontSize:'2.82223px',fontFamily:'Arial',fontWeight:'bold',fill:'#52C9ED',strokeWidth:'0.457999'}}
            x="79.441017"
            y="88.955872"
            id="text240"><tspan
              id="tspan238"
              ...
              x="79.441017"
              y="88.955872">Nairobi</tspan></text>
        </g>
      </svg>

      <a.p style={{color:fill}}>Welcome to</a.p>
      <h2>Nairobi City</h2>
      <a.p style={{color:fill}}>Gain exclusive access to be among the first to witness this remarkable project come to life.<br/> As a valued member of our community, you'll receive exciting updates, special offers, and early insights into the landmark's creation.</a.p>
      <div className='buttons'>
        <a.button style={{color:fill, borderColor: fill}}>Join Our Mailing List <a.svg style={{fill}} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M64 208.1L256 65.9 448 208.1v47.4L289.5 373c-9.7 7.2-21.4 11-33.5 11s-23.8-3.9-33.5-11L64 255.5V208.1zM256 0c-12.1 0-23.8 3.9-33.5 11L25.9 156.7C9.6 168.8 0 187.8 0 208.1V448c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V208.1c0-20.3-9.6-39.4-25.9-51.4L289.5 11C279.8 3.9 268.1 0 256 0z"/></a.svg></a.button>
        <button>Register for the Beta <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM504 312V248H440c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V136c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z"/></svg></button>
      </div>
      <a.span style={{color:fill}} className='footer'>Nairobi City landing page concept by: Franklin Barto</a.span>
    </OverlayDiv>
  )
}
